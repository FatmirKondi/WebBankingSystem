...
<body>
  ...
  <section class="sliding px-0 w-100">
    <div class="container-fluid">
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-interval="750" data-ride="carousel">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body bg-secondary">
                  <p class="card-text" style="text-align: center; ">Customer List</p>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body bg-secondary">
                  <p class="card-text" style="text-align: center;">Make a transfer</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
    ...
    <footer class="pt-4 md-5  border-top">
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small text-light">
            <li><a class="text-muted" href="#">fatmirkondi@unyt.edu.al</a></li>
            <li><a class="text-muted" href="#">+355699451701</a></li>
            <li><a class="text-muted" href="#">+355692021300</a></li>
